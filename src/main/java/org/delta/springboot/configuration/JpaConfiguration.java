package org.delta.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "org.delta.springboot.repositories",
...
public class JpaConfiguration {
	 ...
	 @Autowired
	    ...
	    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
	        ...
	        factoryBean.setPackagesToScan(new String[] { "org.delta.springboot.model" });
